...
module.exports.add_patients =function(name,email,phone,age,gender,medical_history){
    var query = "insert into patients (name,email,phone,age,gender,medical_history) values ('"+name+"', '"+email+"', '"+phone+"','"+age+"','"+gender+"','"+medical_history+"')";
    con.query(query,callback);}
